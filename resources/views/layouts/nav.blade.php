<!-- Sidebar -->
<div id="hs-sidebar-content-push" class="hs-overlay [--body-scroll:true] lg:[--overlay-backdrop:false] [--is-layout-affect:true] [--opened:lg] [--auto-close:lg] hs-overlay-open:translate-x-0 lg:hs-overlay-layout-open:translate-x-0 lg:block lg:-translate-x-full lg:inset-e-auto lg:bottom-0 w-64 [--body-scroll:true]
...
<!-- Content -->
<div class="sm:hs-overlay-layout-open:ms-64 min-h-160 bg-layer transition-all duration-300">
  <!-- Navigation Toggle -->
  <div class="lg:hidden p-2">
    <button type="button" class="flex justify-center items-center gap-x-3 size-8 text-sm text-muted-foreground-2 hover:bg-muted-hover rounded-full disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-muted-focus" aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-sidebar-content-push" aria-label="Toggle navigation" data-hs-overlay="#hs-sidebar-content-push">
