...
<div class="max-w-2xl mx-auto mt-10 p-8 bg-white rounded-3xl shadow-lg">
    ...
    <form action="/categories" method="POST">
        ...
        <div class="mb-8">
            ...
            <input type="text" name="name" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition" placeholder="e.g. Laptop, Furniture">
        </div>
        <div class="flex items-center justify-end space-x-4 border-t pt-6">
            ...
            <button type="submit" class="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-lg shadow-md transition transform active:scale-95">Save Category</button>
        </div>
    </form>
</div>
@endsection